...
namespace ConsoleApp3
{
    class Program
    {
        ...
        {
            var predmeti = new SortedList<string, string>();
            ...
            var o1 = new SortedList<string, int>();
            o1.Add("RE2", 5);
            o1.Add("FMS", 4);
            o1.Add("NUMAT", 3);
            o1.Add("OOP", 4);
            o1.Add("RMMU", 5);
            var o2 = new SortedList<string, int>() { { "RE2", 3 }, { "FMS", 4 }, { "NUMAT", 5 }, { "OOP", 4 }, { "RMMU", 3 } };
            var o3 = new SortedList<string, int>() { { "RE2", 5 }, { "FMS", 2 }, { "NUMAT", 4 }, { "OOP", 3 }, { "RMMU", 4 } };
            var o4 = new SortedList<string, int>() { { "RE2", 3 }, { "FMS", 3 }, { "NUMAT", 2 }, { "OOP", 2 }, { "RMMU", 4 } };
