...
namespace ConsoleApp2
{
    class Student
    {
        ...
        private Dictionary<string, int> _ocjene;
        public Student(string ime, string prezime, string jmbag, Dictionary<string, int> ocjene)
        {
            _ime = ime;
            _prezime = prezime;
            _jmbag = jmbag;
        ...
        public Dictionary<string, int> Ocjene
        {
            get { return _ocjene; }
        }
        ...
        public void NoviPredmet(Dictionary<string, string> predmeti, string ID_predmeta, int ocjena)
        {
            if (Ocjene.ContainsKey(ID_predmeta))
            {
